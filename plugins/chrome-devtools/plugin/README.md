...
If you intentionally want rolling upstream updates, change the package in `plugin/mcp/servers.yaml` from:
...
If you want different runtime behavior later, add official upstream flags in `plugin/mcp/servers.yaml`, then regenerate.
